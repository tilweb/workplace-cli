"""Anthropic frontend-design skill, ported as a Workplace-CLI built-in.

Source: https://github.com/anthropics/skills/tree/main/skills/frontend-design
License: Apache-2.0 (Anthropic, see NOTICE for attribution).

We embed the SKILL.md verbatim as a Python string so it ships with the
package — no on-disk SKILL.md file is required. User-invocable via
`/frontend-design` in the TUI.
"""
