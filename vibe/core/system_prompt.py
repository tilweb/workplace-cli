...
def _add_commit_signature() -> str:
    return (
        ...
        "It will always be suffixed with a line telling it was generated by KI Workplace CLI with the appropriate co-authoring information.\n"
        "The format you will always uses is the following heredoc.\n\n"
        "```bash\n"
        "git commit -m <Commit message here>\n\n"
        "Generated by KI Workplace CLI.\n"
        "Co-Authored-By: KI Workplace CLI <workplace@adacor.ai>\n"
        "```"
    )
